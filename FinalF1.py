...
def main():
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN and inp_active:
                if event.key == pygame.K_BACKSPACE:
                    ...
                    org_player = text_input
                    current_player = text_input.lower().strip()
                    #hier muss ich eingreufen und sagen joo wt geht ab der name wurde schon eingegeben heist ich werde mit visible 
                    #wert arbeiten und dann sagen wenn current_player schon in Rang 
        ...
        if not early_click:
            ...
            warnin_g = buba_font.render("Bitte warten!", True, "white")
            display.blit(warnin_g, (1920//2.6,560))
        ...
        if ex_name:
           ...
           display.blit(ja, (input_box.x+input_box.width+100,input_box.y+47))
        ...
        #ich muss um die richtige box zu bekommen die differenz zwischnen dem letzten 30 und dem jetztigen Spieler heraus finden 
        now_i = None
